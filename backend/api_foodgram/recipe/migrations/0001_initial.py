# Generated by Django 2.2.16 on 2022-07-02 19:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='in_favorite', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь',)),
                ('recipe', models.ManyToManyField(related_name='in_favorite', to='favorite.Recipe', verbose_name='Ингредиенты')),
            ],
        ),
        migrations.CreateModel(
            name='Ingredients',
